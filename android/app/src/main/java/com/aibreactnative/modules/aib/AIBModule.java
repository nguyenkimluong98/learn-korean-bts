...
public class AIBModule extends ReactContextBaseJavaModule {
    ...
    public void showProgressDialog(String message) {
        LocalBroadcastManager.getInstance(context)
                .sendBroadcast(new Intent(MainActivity.ACTION_SHOW_PROGRESS_DIALOG).putExtra("message", message));
    }
    ...
    public void showExitNativeAd() {
        LocalBroadcastManager.getInstance(context)
                .sendBroadcast(new Intent(MainActivity.ACTION_SHOW_EXIT_NATIVE_ACTIVITY));
    }
}
